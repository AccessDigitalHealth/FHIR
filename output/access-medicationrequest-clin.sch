...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationRequest/f:note">
      ...
      <sch:assert test="count(f:authorReference) &lt;= 1">authorReference: maximum cardinality of 'authorReference' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationRequest/f:dosageInstruction/f:doseAndRate">
      ...
      <sch:assert test="count(f:doseRange) &lt;= 1">doseRange: maximum cardinality of 'doseRange' is 1</sch:assert>
